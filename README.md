...
The script ./src/Tests/binance.R, has some tests to get the information from Binance.
...
Next, the description of each strategy is listed by script located in ./src/Strategies/:
